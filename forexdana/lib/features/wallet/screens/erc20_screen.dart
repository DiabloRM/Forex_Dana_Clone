...
class Erc20Screen extends StatelessWidget {
  const Erc20Screen({super.key});
                    ...
                    children: [
                      ...
                      Center(
                        child: Container(
                          ...
                          child: QrImageView(
                            data: '0x742d35Cc6634C0532925a3b8D4C9db96C4b4d8b6',
                      ...
                      const SizedBox(height: 8),
                      const Text(
                        '• You can only deposit ERC20-USDT to this address. If you deposit any other crypto then it will be lost and will not be recoverable.',
                        style: TextStyle(
                          fontSize: 13,
                          color: Colors.grey,
                          height: 1.4,
