...
class Trc20Screen extends StatelessWidget {
  const Trc20Screen({super.key});
                    ...
                    children: [
                      ...
                      Center(
                        child: Container(
                          ...
                          child: QrImageView(
                            data: 'TQn9Y2khDD95J42FQtQTdwVVRqjJ6K9qQq',
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            const Expanded(
                              child: Text(
                                'TQn9Y2khDD95J42FQtQTdwVVRqjJ6K9qQq',
                                style: TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.w500,
                                  letterSpacing: 0.5,
                      ...
                      const SizedBox(height: 8),
                      const Text(
                        '• You can only deposit TRC20-USDT to this address. If you deposit any other crypto then it will be lost and will not be recoverable.',
                        style: TextStyle(
                          fontSize: 13,
                          color: Colors.grey,
                          height: 1.4,
