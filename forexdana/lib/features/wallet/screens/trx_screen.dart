                    ...
                    children: [
                      ...
                      Center(
                        child: Container(
                          ...
                          child: QrImageView(
                            data: 'TYixqqMnMxqVHp4hJ6MHbCbRNdLCpJxh2n',
                      ...
                      Container(
                        ...
                        child: Row(
                          children: [
                            const Expanded(
                              child: Text(
                                'TYixqqMnMxqVHp4hJ6MHbCbRNdLCpJxh2n',
                                style: TextStyle(
                                  fontSize: 14,
                                  fontWeight: FontWeight.w500,
                                  letterSpacing: 0.5,
                      ...
                      const SizedBox(height: 8),
                      const Text(
                        '• You can only deposit TRC20-TRX to this address. If you deposit any other crypto then it will be lost and will not be recoverable.',
                        style: TextStyle(
                          fontSize: 13,
                          color: Colors.grey,
                          height: 1.4,
